...
class PendingPaymentsReportForm extends FormBase {

  public function getFormId() {
    return 'pending_payments_report_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    // Only past-due (end_date <= yesterday)
    $yesterday = (new \DateTime('yesterday'))->format('Y-m-d');
    $query->condition('l.end_date', $yesterday, '<=');

    // Only show records with status 'Pending'
    $query->condition('l.status', 'pending');
